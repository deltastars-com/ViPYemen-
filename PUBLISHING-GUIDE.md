...
| **الإصدار الحالي** | 6.7.1 |
| **رمز الإصدار (Android)** | 6070001 |
...
| **كلمة مرور الـ Keystore** | `ViPYemen2026@Sign` |
| **الـ Key Alias** | `vipyemen` |
| **كلمة مرور المفتاح** | `ViPYemen2026@Sign` |
...
> لذا تُثبَّت النسخ الجديدة فوق القديمة مباشرة دون حذف. جميع القيم أعلاه حقيقية ومستخدمة فعلياً.
