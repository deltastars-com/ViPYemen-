...
export const ensureSeedData = mutation({
  ...
  handler: async (ctx) => {
    ...
    // الإصدار 6.2.0 — قسم الإصدارات إدارة فقط، تنقلات لوحة تحكم سلسة، محرك معرفي مزدوج
    const v620 = await ctx.db
      .query("releases")
      .filter((q) => q.eq(q.field("version"), "6.2.0"))
      .first();
    if (!v620) {
      await ctx.db.insert("releases", {
        version: "6.2.0",
        title: "تطبيق Android 6.2.0 — قسم الإصدارات الإداري والمساعد المزدوج (APK)",
        description:
          "الإصدار 6.2.0: نقل قسم الإصدارات والتطبيقات كاملاً إلى داخل لوحة التحكم (خاص بالإدارة فقط ولا يظهر للزوار)، تنقلات سلسة داخل لوحة التحكم (رجوع، محوّل سريع بين الأقسام، خروج إلى الموقع بدون تسجيل خروج)، زر قفل بالبصمة والوجه، ومحرك معرفي مزدوج DeepSeek + Gemini مع تحويل تلقائي.",
        platform: "android",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/download/v6.2.0/vip-yemen-android-v6.2.0.apk",
        notes: "الحزمة com.vip.yemen — تحديث مباشر فوق 6.1.1 بدون حذف",
        createdAt: now,
      });
      await ctx.db.insert("releases", {
        version: "6.2.0",
        title: "حزمة Google Play — AAB 6.2.0",
        description: "حزمة AAB موقّعة بكل تحسينات 6.2.0، جاهزة للرفع إلى Google Play Console.",
        platform: "android",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/download/v6.2.0/vip-yemen-android-v6.2.0.aab",
        notes: "استخدم store-listing.json و SIGNING-AND-OWNERSHIP.md",
        createdAt: now,
      });
      await ctx.db.insert("releases", {
        version: "6.2.0",
        title: "تطبيق الويب المتقدم 6.2.0 (PWA)",
        description: "نسخة الويب 6.2.0 مع كل مميزات 6.2: قسم إصدارات إداري خاص، تنقلات سلسة، ومحرك المعرفة المزدوج.",
        platform: "web",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/download/v6.2.0/vip-yemen-web-pwa-v6.2.0.zip",
        notes: "تثبيت مباشر كتطبيق ويب تقدمي ثابت — تحديث تلقائي",
        createdAt: now,
      });
      await ctx.db.insert("releases", {
        version: "6.2.0",
        title: "تطبيق iOS — IPA 6.2.0",
        description: "تطبيق iOS للحزمة com.vip.yemen بالإصدار 6.2.0 — يُبنى عبر Codemagic ويرفع إلى App Store Connect.",
        platform: "ios",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/latest",
        notes: "انظر codemagic.yaml لخطوات البناء والتوقيع",
      ...
      await ctx.db.insert("releases", {
        ...
        title: "الكود المصدري الكامل + ملفات التوقيع والتوثيق والمتاجر",
        description:
          "الكود المصدري الكامل للإصدار 6.2.0، ملف التوقيع (PKCS12)، store-listing.json، PRIVACY-POLICY-APP.md، SIGNING-AND-OWNERSHIP.md، codemagic.yaml، وجميع ملفات المتاجر.",
        platform: "docs",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/download/v6.2.0/vip-yemen-source-v6.2.0.zip",
        notes: "جميع ملفات الرفع لمتجر Google Play و App Store",
        createdAt: now,
      });
    }

    // الإصدار 6.2.2 — المساعد الذكي Gemini فقط (إزالة DeepSeek) + زر خروج من الواجهة
    const v622 = await ctx.db
      .query("releases")
      .filter((q) => q.eq(q.field("version"), "6.2.2"))
      .first();
    if (!v622) {
      await ctx.db.insert("releases", {
        version: "6.2.2",
        title: "تطبيق Android 6.2.2 — المساعد الذكي Gemini وزر الخروج (APK)",
        description:
          "الإصدار 6.2.2: إصلاح خطأ المساعد الذكي — الاعتماد الكامل على محرك Gemini AI فقط بأحدث النماذج مع تحويل تلقائي عند تحديثها، زر خروج في الواجهة العامة لإنهاء الجلسة بعد الاستخدام، وكل مميزات 6.2.",
        platform: "android",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/download/v6.2.2/vip-yemen-android-v6.2.2.apk",
        notes: "الحزمة com.vip.yemen — تحديث مباشر فوق 6.2.0 بدون حذف",
        createdAt: now,
      });
      await ctx.db.insert("releases", {
        version: "6.2.2",
        title: "حزمة Google Play — AAB 6.2.2",
        description: "حزمة AAB موقّعة بالإصدار 6.2.2 مع إصلاح المساعد الذكي وزر الخروج، جاهزة للرفع إلى Google Play Console.",
        platform: "android",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/download/v6.2.2/vip-yemen-android-v6.2.2.aab",
        notes: "استخدم store-listing.json و SIGNING-AND-OWNERSHIP.md",
        createdAt: now,
      });
      await ctx.db.insert("releases", {
        version: "6.2.2",
        title: "تطبيق الويب المتقدم 6.2.2 (PWA)",
        description: "نسخة الويب 6.2.2: المساعد الذكي يعمل بمحرك Gemini فقط بدون أخطاء، وزر خروج في القائمة الرئيسية.",
        platform: "web",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/download/v6.2.2/vip-yemen-web-pwa-v6.2.2.zip",
        notes: "تثبيت مباشر كتطبيق ويب تقدمي ثابت — تحديث تلقائي",
        createdAt: now,
      });
      await ctx.db.insert("releases", {
        version: "6.2.2",
        title: "تطبيق iOS — IPA 6.2.2",
        description: "تطبيق iOS للحزمة com.vip.yemen بالإصدار 6.2.2 — يُبنى عبر Codemagic ويرفع إلى App Store Connect.",
        platform: "ios",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/latest",
        notes: "انظر codemagic.yaml لخطوات البناء والتوقيع",
      ...
      await ctx.db.insert("releases", {
        ...
        title: "الكود المصدري الكامل + ملفات التوقيع والتوثيق والمتاجر",
        description:
          "الكود المصدري الكامل للإصدار 6.2.2، ملف التوقيع (PKCS12)، store-listing.json، PRIVACY-POLICY-APP.md، SIGNING-AND-OWNERSHIP.md، codemagic.yaml، وجميع ملفات المتاجر.",
        platform: "docs",
        fileUrl:
          "https://github.com/deltastars-com/ViPYemen-/releases/download/v6.2.2/vip-yemen-source-v6.2.2.zip",
        notes: "جميع ملفات الرفع لمتجر Google Play و App Store",
        createdAt: now,
      });
    }
