...
const DICT: Record<string, { ar: string; en: string }> = {
  ...
  footerPayments: { ar: "الدفع الآمن", en: "Secure Payments" },
  footerDownloadAndroid: { ar: "تحميل تطبيق أندرويد", en: "Download Android app" },
  footerDownloadIos: { ar: "تحميل تطبيق iPhone", en: "Download iPhone app" },
  footerIosSoon: { ar: "نسخة iOS — يُفعَّل الرابط تلقائياً بعد إضافة رابط متجر آبل من قسم المطور", en: "iOS version — link activates automatically after adding the App Store URL in the Developer section" },
